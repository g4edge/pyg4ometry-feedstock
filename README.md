...
Once the `conda-forge` channel has been enabled, `pyg4ometry` can be installed with:

```
conda install pyg4ometry
```

It is possible to list all of the versions of `pyg4ometry` available on your platform with:
